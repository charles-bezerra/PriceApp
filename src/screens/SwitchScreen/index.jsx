...
export default () => {
    ...
    const effect = React.useCallback( () => {
        if (product) {
            ...
            getRealm()
            .then( (realm) => {
                const newproduct = realm.objectForPrimaryKey('Product', product.barcode);
    ...
    return (
        <Page>
            ...
            >
                <View>
                    <Text style={{ fontSize: 22, fontWeight: '500', marginBottom: 8 }}>Produto não encontrado</Text>
                    <Text style={{ fontSize: 16, fontWeight: '300', marginBottom: 40 }}>Deseja criar um novo?</Text>
                    ...
                    <Row>
                        ...
                        <Col width="50%" style={{ justifyContent: 'center', paddingStart: 8 }}>
